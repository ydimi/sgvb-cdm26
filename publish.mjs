...
//  - mobile (< 960px) : bouton hamburger FLOTTANT (haut-droite), menu en panneau au tap,
//    aucun decalage du contenu -> tout l'ecran reste dispo pour les graphes ;
//  - large (>= 960px) : menu classique en barre fixe pleine largeur, pas de hamburger.
...
const NAV_BAR = `<style>
  ...
  /* Desktop / large (>= 960px) : barre classique, pas de hamburger */
